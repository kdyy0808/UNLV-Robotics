...
//       1.0d: add servo mode (to select wheel or joint mode)
...
void XL320_servo(unsigned char XL320_motorId,
  ...
  // 1. Calculate lengths
  // Recall that Length 1 and Length 2 = number of parameters + 3
  // Setting Servo Mode requires only 6 parameters: Goal Position, 0x00, Position_L,
